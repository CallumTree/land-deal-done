...
export const PROPERTY_DEFAULTS: Record<string, Partial<PropertyRow>> = {
  ...
  "2-Bed Semi with Garage": { giaPerUnit: 68, salesValue: 235600, buildPerSqm: 1650, unitPriceOverride: 0 },
  "3-Bed Semi": { giaPerUnit: 90, salesValue: 292500, buildPerSqm: 1650, unitPriceOverride: 0 },
  "3-Bed Semi with Garage": { giaPerUnit: 88, salesValue: 300300, buildPerSqm: 1650, unitPriceOverride: 0 },
  ...
  "4-Bed Detached Executive": { giaPerUnit: 145, salesValue: 563800, buildPerSqm: 1850, unitPriceOverride: 0 },
  "1-Bed Bungalow": { giaPerUnit: 50, salesValue: 175900, buildPerSqm: 1800, unitPriceOverride: 0 },
  "2-Bed Bungalow": { giaPerUnit: 84.5, salesValue: 283075, buildPerSqm: 1800, unitPriceOverride: 0 },
  "2-Bed Bungalow with Garage": { giaPerUnit: 72, salesValue: 250700, buildPerSqm: 1800, unitPriceOverride: 0 },
  "3-Bed Bungalow": { giaPerUnit: 109, salesValue: 370600, buildPerSqm: 1900, unitPriceOverride: 0 },
  "3-Bed Bungalow with Garage": { giaPerUnit: 94, salesValue: 332600, buildPerSqm: 1900, unitPriceOverride: 0 },
...
export const PROPERTY_TYPES = [
  "1-Bed Bungalow",
  "2-Bed Semi",
  "2-Bed Semi with Garage",
  "3-Bed Semi",
  "3-Bed Semi with Garage",
  "3-Bed Detached",
  "4-Bed Detached",
  "4-Bed Detached Executive",
  "2-Bed Bungalow",
  "2-Bed Bungalow with Garage",
  "3-Bed Bungalow",
  "3-Bed Bungalow with Garage",
  "Apartment (1-bed)",
  "Apartment (2-bed)",
  "Custom",
];
